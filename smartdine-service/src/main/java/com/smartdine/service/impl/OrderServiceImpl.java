...
import com.smartdine.exception.OrderBusinessException;
import com.smartdine.mapper.*;
import com.smartdine.result.PageResult;
import com.smartdine.service.OrderService;
import com.smartdine.service.ShoppingCartService;
import com.smartdine.utils.HttpClientUtil;
import com.smartdine.utils.WeChatPayUtil;
import com.smartdine.vo.*;
import com.smartdine.websocket.WebSocketServer;
...
public class OrderServiceImpl implements OrderService {
    ...
    @Value("${smartdine.shop.address}")
    private String shopAddress;

    @Value("${smartdine.baidu.ak}")
    private String ak;
    ...
    public String generateOrderNumber() {
        ...
        // 3. 组合生成订单号（例如�?0230801153045123456�?
    ...
    public OrderSubmitVO submit(OrdersSubmitDTO ordersSubmitDTO) {
        ...
        String number = orders.getNumber();//获取订单�?
        //通过订单号获取VO信息
    ...
    public OrderPaymentVO payment(OrdersPaymentDTO ordersPaymentDTO) throws Exception {
        ...
        //为替代微信支付成功后的数据库订单状态更新，多定义一个方法进行修�?
        Integer OrderPaidStatus = Orders.PAID; //支付状态，已支�?
        Integer OrderStatus = Orders.TO_BE_CONFIRMED;  //订单状态，待接�?

        //发现没有将支付时�?check_out属性赋值，所以在这里更新
        ...
        map.put("type",1);
        map.put("orderId",id);
        map.put("content","订单�?"+orderNumber);
